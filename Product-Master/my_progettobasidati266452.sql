...
--
-- Host: localhost
-- Generation Time: Feb 27, 2018 alle 22:31
...
--
-- Database: `my_progettobasidati266452`
--
...
(10003, 'samsung', 'ihateapple', 'melamarcia', 'samsung@samsung.it', 'Via del galaxy 22', 'America', 34353453, ''),
(12345, 'Louvre', 'Love_Paris', 'napoleone', 'louvre@gmail.com', 'Via Parigi 123', 'Francia', 96532323, ''),
(453464, 'Eminflex', 'eminflex_1344', 'mastrota65', 'eminflex@azienda.it', 'Via Emin 22', 'Italia', 52133543, ''),
(4562356, 'apple', 'apple_store', 'melamorsicata', 'apple@applemail.it', 'Via della mela', 'America', 35252563, ''),
(185645, 'Unipr SPA', 'Unipr', 'psw', 'unipr@ingegneria.com', 'Via Dell''informazione', 'Italia', 23432342, '');
...
CREATE TABLE IF NOT EXISTS `Prodotto` (
  ...
  `Nome` varchar(25) DEFAULT NULL,
  `Prezzo_Vendita` int(11) DEFAULT NULL,
  `Scorte_Magazzino` int(11) DEFAULT NULL,
...
(1000, 'Claudio', 'Pratico', 'ClaudioUNIPR', 'psw', 1, 'claudio.pratico1@studenti.unipr.it', 'Via Vittorio Gramsci 18', 'Italia', 12345678, 'SELECT Cod_Prodotto, Cod_Categoria, Nome, Prezzo_Vendita, Scorte_Magazzino FROM Prodotto WHERE Cod_Prodotto = 234 OR Cod_Prodotto = 987 OR Cod_Prodotto = 3439 OR Cod_Prodotto = 56346 OR Cod_Prodotto = 65463 OR Cod_Prodotto = 0 '),
(1001, 'Daniele', 'Ricci', 'Taralluccio18', 'vino1996', 0, 'daniele.ricci@studenti.unipr.it', 'Via Vittorio Emanuele 16', 'Albania', 334535785, 'SELECT Cod_Prodotto, Cod_Categoria, Nome, Prezzo_Vendita, Scorte_Magazzino FROM Prodotto WHERE Cod_Prodotto = 234 OR Cod_Prodotto = 987 OR Cod_Prodotto = 3439 OR Cod_Prodotto = 56346 OR Cod_Prodotto = 65463 OR Cod_Prodotto = 0 '),
(1002, 'Dina', 'Como', 'Pandistelle2001', 'comodina23', 0, 'lovecookies19@studenti.unipr.it', 'Via Prato Fiorito 19', 'Afghanistan', 348534453, 'SELECT Cod_Prodotto, Cod_Categoria, Nome, Prezzo_Vendita, Scorte_Magazzino FROM Prodotto WHERE Cod_Prodotto = 234 OR Cod_Prodotto = 987 OR Cod_Prodotto = 3439 OR Cod_Prodotto = 56346 OR Cod_Prodotto = 65463 OR Cod_Prodotto = 0 '),
(1003, 'Silvio', 'Riccio', 'Monkey01', 'axwest986', 0, 'silvio.riccio@studenti.unipr.it', 'Via Bordo del parmigianino 24', 'Italia', 343546434, 'SELECT Cod_Prodotto, Cod_Categoria, Nome, Prezzo_Vendita, Scorte_Magazzino FROM Prodotto WHERE Cod_Prodotto = 234 OR Cod_Prodotto = 987 OR Cod_Prodotto = 3439 OR Cod_Prodotto = 56346 OR Cod_Prodotto = 65463 OR Cod_Prodotto = 0 '),
(1004, 'Alessandra', 'Ollari', 'BellinaFiorellina50', 'girasole23', 0, 'alessandra.ollari@studenti.unipr.it', 'Via Leonardo Prati 134', 'Italia', 343345465, 'SELECT Cod_Prodotto, Cod_Categoria, Nome, Prezzo_Vendita, Scorte_Magazzino FROM Prodotto WHERE Cod_Prodotto = 234 OR Cod_Prodotto = 987 OR Cod_Prodotto = 3439 OR Cod_Prodotto = 56346 OR Cod_Prodotto = 65463 OR Cod_Prodotto = 0 '),
(3454, 'Rooty', 'Rootini', 'root', 'psw', 1, 'root@rootmail.root', 'amministrazione', 'Roothingam', 999999999, 'SELECT Cod_Prodotto, Cod_Categoria, Nome, Prezzo_Vendita, Scorte_Magazzino FROM Prodotto WHERE Cod_Prodotto = 234 OR Cod_Prodotto = 987 OR Cod_Prodotto = 3439 OR Cod_Prodotto = 56346 OR Cod_Prodotto = 65463 OR Cod_Prodotto = 0 ');
